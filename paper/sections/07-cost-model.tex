...
RaS has an economic motivation, but paper v0.1 does not have evidence for monetary savings. The hostile audit therefore separates a theoretical stress model, observable resource accounting, and unobservable provider-internal economics.
...
\input{tables/cost-observability}
