...
The public repository must never contain proprietary source, proprietary diffs, hidden proprietary verifier source, private source snapshots, credentials, secrets, private model traces containing proprietary source, Very Group material, customer data or unnecessary personal filesystem paths.
